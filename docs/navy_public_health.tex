...
You can do a lot of customizations through the \texttt{datatable} call. For example, you can
...
\begin{figure*}
\includegraphics{navy_public_health_files/figure-latex/plotly1-1} \end{figure*}
...
\begin{figure*}
\includegraphics{navy_public_health_files/figure-latex/plotly2-1} \end{figure*}
...
\includegraphics{navy_public_health_files/figure-latex/unnamed-chunk-23-1}
